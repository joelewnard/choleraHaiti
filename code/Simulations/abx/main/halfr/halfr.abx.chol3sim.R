...
set.seed(310103)
load(file='~/halfr.chol3.mcmc.Rdata')
...
for (l in 1:nsims){
  par = c(pars,halfr.state3[sample(2001:25000,1),,sample(1:3,1)])
...
halfr.abx.chol3sim = out

save(halfr.abx.chol3sim,file='halfr.abx.chol3sim.Rdata')
