...
set.seed(110103)
load(file='~/halfr.chol1.mcmc.Rdata')
...
for (l in 1:nsims){
  par = c(pars,halfr.state1[sample(2001:25000,1),,sample(1:3,1)])
...
halfr.abx.chol1sim = out

save(halfr.abx.chol1sim,file='halfr.abx.chol1sim.Rdata')
