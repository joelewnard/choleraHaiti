...
set.seed(210103)
load(file='~/halfr.chol2.mcmc.Rdata')
...
for (l in 1:nsims){
  par = c(pars,halfr.state2[sample(2001:25000,1),,sample(1:3,1)])
...
halfr.abx.chol2sim = out

save(halfr.abx.chol2sim,file='halfr.abx.chol2sim.Rdata')
