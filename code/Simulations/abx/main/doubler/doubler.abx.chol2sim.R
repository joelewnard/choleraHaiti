...
set.seed(210107)
load(file='~/doubler.chol2.mcmc.Rdata')
...
for (l in 1:nsims){
  par = c(pars,doubler.state2[sample(2001:25000,1),,sample(1:3,1)])
...
doubler.abx.chol2sim = out

save(doubler.abx.chol2sim,file='doubler.abx.chol2sim.Rdata')
