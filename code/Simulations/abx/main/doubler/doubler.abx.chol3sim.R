...
set.seed(210107)
load(file='~/doubler.chol3.mcmc.Rdata')
...
for (l in 1:nsims){
  par = c(pars,doubler.state3[sample(2001:25000,1),,sample(1:3,1)])
...
doubler.abx.chol3sim = out

save(doubler.abx.chol3sim,file='doubler.abx.chol3sim.Rdata')
