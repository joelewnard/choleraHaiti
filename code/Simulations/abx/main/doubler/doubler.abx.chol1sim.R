...
set.seed(110107)
load(file='~/doubler.chol1.mcmc.Rdata')
...
for (l in 1:nsims){
  par = c(pars,doubler.state1[sample(2001:25000,1),,sample(1:3,1)])
...
doubler.abx.chol1sim = out

save(doubler.abx.chol1sim,file='doubler.abx.chol1sim.Rdata')
