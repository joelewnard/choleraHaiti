...
gammaA = 0.1964637
gammaAbx = 1/(1/gammaA - 1.50*rnorm(5e3,pars.abx[1],pars.abx[2]))
...
abx50.quartervax.chol1sim = out

save(abx50.quartervax.chol1sim,file='abx50.quartervax.chol1sim.Rdata')
