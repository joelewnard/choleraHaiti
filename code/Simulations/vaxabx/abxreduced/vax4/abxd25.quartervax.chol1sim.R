...
gammaA = 0.1964637
gammaAbx = 1/(1/gammaA - 0.75*rnorm(5e3,pars.abx[1],pars.abx[2]))
...
abxd25.quartervax.chol1sim = out

save(abxd25.quartervax.chol1sim,file='abxd25.quartervax.chol1sim.Rdata')
