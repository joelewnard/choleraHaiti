...
gammaA = 0.1964637
gammaAbx = 1/(1/gammaA - 0.9*rnorm(5e3,pars.abx[1],pars.abx[2]))
...
abxd10.quartervax.chol1sim = out

save(abxd10.quartervax.chol1sim,file='abxd10.quartervax.chol1sim.Rdata')
