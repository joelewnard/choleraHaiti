...
gammaA = 0.1964637
gammaAbx = 1/(1/gammaA - 0.50*rnorm(5e3,pars.abx[1],pars.abx[2]))
...
abxd50.quartervax.chol1sim = out

save(abxd50.quartervax.chol1sim,file='abxd50.quartervax.chol1sim.Rdata')
